...
import Migration0037 from "./Migrations/037_OrchestrationV2.ts";
import Migration0038 from "./Migrations/038_OrchestrationV2Subagents.ts";
import Migration0039 from "./Migrations/039_OrchestrationV2Foundation.ts";
import Migration0040 from "./Migrations/040_OrchestrationV2ProviderSessionBindings.ts";
import Migration0041 from "./Migrations/041_OrchestrationV2ThreadLaunchWorkflows.ts";
import Migration0042 from "./Migrations/042_ApplicationEventSource.ts";
import Migration0043 from "./Migrations/043_OrchestrationV2EffectCancellation.ts";
import Migration0044 from "./Migrations/044_ScheduledTasks.ts";
import Migration0045 from "./Migrations/045_LegacyV1ImportState.ts";
...
export const migrationEntries = [
  ...
  [37, "OrchestrationV2", Migration0037],
  [38, "OrchestrationV2Subagents", Migration0038],
  [39, "OrchestrationV2Foundation", Migration0039],
  [40, "OrchestrationV2ProviderSessionBindings", Migration0040],
  [41, "OrchestrationV2ThreadLaunchWorkflows", Migration0041],
  [42, "ApplicationEventSource", Migration0042],
  [43, "OrchestrationV2EffectCancellation", Migration0043],
  [44, "ScheduledTasks", Migration0044],
  [45, "LegacyV1ImportState", Migration0045],
] as const;
