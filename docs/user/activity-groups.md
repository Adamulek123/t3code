...
On web and desktop, expand an activity summary in chat to see the agent's tool
calls and reasoning in order. Expanded tool calls scroll with the conversation.
